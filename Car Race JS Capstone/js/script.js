...
$(function() {
   ...
   $("#div_race1").animate( { 
      ...
      left: tracklength1 
       ...
       decider();
       $("#div_car1 span").html("Position: " + position + "<br>Time taken: " + raceduration1 + " milliseconds");
   });
        $("#div_race2").animate( { 
      ...
      left: tracklength2 
            ...
            decider();
            $("#div_car2 span").html("Position: " + position + "<br>Time taken: " + raceduration2 + " milliseconds!");
